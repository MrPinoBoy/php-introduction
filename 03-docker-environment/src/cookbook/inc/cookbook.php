...
$pepper_casserole->addIngredient("tomato sauce", 15, "once");
$pepper_casserole->addIngredient("Cheddar Cheese", 8, "once");
...
$lasagna->addIngredient("Tomato Sauce", 64, "once");
...
$lasagna->addIngredient("Ricotta Cheese", 8, "once");
$lasagna->addIngredient("Mozzarella Cheese", 16, "once");
...
$dried_mushroom_ragout->addIngredient("Sour Cream", 3.5, "once");
...
$rabbit_catalan->addIngredient("Raisins", 1.5, "once");
$rabbit_catalan->addIngredient("Rabbit", 14, "once");
...
$rabbit_catalan->addIngredient("Tomatoes, skinned, liquidized, and strained", 12, "once");
$rabbit_catalan->addIngredient("Rabbit stock", 7.5, "once");
...
$rabbit_catalan->addIngredient("Xocolata a la pedra", .5, "once");
...
$grilled_salmon_with_fennel->addIngredient("Orange liquor", .25, "once");
...
$pistachio_duck->addIngredient("Duck stock", 8, "once");
$pistachio_duck->addIngredient("Port wine", .5, "once");
...
$beef_medallions->addIngredient("Ruby Port", 3, "once");
$beef_medallions->addIngredient("Red wine", 2, "once");
...
$beef_medallions->addIngredient("Demi-glace or meat glaze", 5, "once");
...
$spicy_omelette->addIngredient("Kielbasa sausage", 4, "once");
